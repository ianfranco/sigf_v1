 ...
 * @author ianfr
 */
@Named(value = "registroReconocimientoDeudaController")
@ViewScoped
public class RegistroReconocimientoDeuda implements Serializable {
     ...
     */
    public RegistroReconocimientoDeuda() {
        this.descuentoTrabajadorDao = new DescuentoTrabajadorDaoImpl();
        this.saldoAnterior = this.descuentoTrabajadorDao.findById(5);
    ...
    public void saveNew() {
        if (this.selected != null) {
            ...
            try {
                ...
                JsfUtil.addSuccessMessage("Se ha registrado un Reconocimiento de: "+this.selected.getMonto()+" al Trabajador:"+this.selected.getTrabajador());
                this.selected = null;
