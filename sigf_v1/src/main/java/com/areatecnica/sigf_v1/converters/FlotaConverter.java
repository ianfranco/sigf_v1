...
public class FlotaConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Flota) {
            Flota o = (Flota) object;
            return getStringKey(o.getIdFlota());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Flota.class.getName()});
            return null;
        }
    }
