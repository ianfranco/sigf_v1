...
@FacesConverter(value = "controlConverter")
public class ControlConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Control) {
            Control o = (Control) object;
            return getStringKey(o.getIdControl());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Control.class.getName()});
            return null;
        }
    }
