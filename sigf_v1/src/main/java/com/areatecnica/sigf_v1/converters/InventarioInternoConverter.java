...
public class InventarioInternoConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        this.dao = new InventarioInternoDaoImpl();
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof InventarioInterno) {
            InventarioInterno o = (InventarioInterno) object;
            return getStringKey(o.getIdInventarioInterno());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), InventarioInterno.class.getName()});
            return null;
        }
    }
