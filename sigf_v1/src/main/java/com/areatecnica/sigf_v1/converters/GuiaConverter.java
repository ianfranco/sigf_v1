...
public class GuiaConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Guia) {
            Guia o = (Guia) object;
            return getStringKey(o.getIdGuia());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Guia.class.getName()});
            return null;
        }
    }
