...
@FacesConverter(value = "unidadNegocioConverter")
public class UnidadNegocioConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof UnidadNegocio) {
            ...
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), UnidadNegocio.class.getName()});
            return null;
        }
    }
